...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    DOWNLOAD_LOCATIONS_CSV: '/download-locations-csv',
    DOWNLOAD_INTERMEDIATE_DATA: '/download-intermediate-data',
    LIST_INTERMEDIATE_DATA: '/list-intermediate-data',
    DOWNLOAD_STATISTICS_CSV: '/download-statistics-csv',
    DOWNLOAD_DIFF_STATISTICS: '/download-diff-statistics',
